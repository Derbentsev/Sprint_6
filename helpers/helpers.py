...
class TestHelpers:
    def fill_order_page(order_page: OrderPage, order_data: dict[str, str]):
        order_page.fill_input_field(OrderPageLocators.input_first_name, order_data['first_name'])
        order_page.fill_input_field(OrderPageLocators.input_last_name, order_data['last_name'])
        order_page.fill_input_field(OrderPageLocators.input_address, order_data['address'])
        order_page.fill_metro_station(order_data['metro_station'])
        order_page.fill_input_field(OrderPageLocators.input_telephone, order_data['telephone'])
        ...
        order_page.fill_input_field(OrderPageLocators.input_comment, order_data['comment'])
        order_page.click_on_element(OrderPageLocators.order_button)
        order_page.click_on_element(OrderPageLocators.order_yes_button)
